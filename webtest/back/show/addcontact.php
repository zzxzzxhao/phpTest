<?php
    ...
    if(empty($site)){
        ...
        $sql  = "insert into `contact`(site,tel,support,nexttel,fax,home,email) values('$site','$tel','$support','$nexttel','$fax','$home','$email')";
        $res = mysql_query($sql)or die(mysql_error());
        if($res){
            echo "<script>alert('添加公司信息成功');location.href='show.php';</script>";
        }else{
